        ...
        if (sharedMemory && sharedMemory->valid()) {
            ...
            while (od4.isRunning()) {
...

                {
                    ...
                    std::cout << "| n = " << numZeroBlue << std::endl << std::endl;

                    if (numZeroYellow > yellowturnthres) {
                        groundSteeringSent = -maxSteering;
                    }
                    else if (numZeroBlue > blueturnthres) {
                        groundSteeringSent = maxSteering;
                    }
                    else {
                        // Moving Average
